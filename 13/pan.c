...
short src_ln0 [] = {
	  0,  37,  39,  39,  40,  40,  41,  41, 
	 42,  42,  43,  43,  38,  45,  38,  45, 
	 47,   7,   8,   8,   9,   9,  10,  10, 
	 11,  11,  12,  12,  13,  13,   7,  15, 
	 16,  16,  17,  17,  18,  18,  15,  20, 
	 20,  24,  24,  25,  25,  26,  28,  28, 
	 29,  29,  27,  31,  27,  23,  32,  32, 
	 50,  47,  52,  52,  46,  54,  46,  54, 
	  0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "mole.pml", 1, 63 },
...
{	int j, h = now._nr_pr;
	...
	case 0:	/* supervisor */
		...
		((P0 *)pptr(h))->i = 0;
		((P0 *)pptr(h))->random = 0;
		((P0 *)pptr(h))->_1_1_1_target = 0;
#ifdef VAR_RANGES
		logval("supervisor:i", ((P0 *)pptr(h))->i);
		logval("supervisor:random", ((P0 *)pptr(h))->random);
		logval("supervisor:target", ((P0 *)pptr(h))->_1_1_1_target);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
iniglobals(int calling_pid)
{
		...
		now.moleposition = 0;
#ifdef VAR_RANGES
		logval("molecaught", now.molecaught);
...
{	/* int i; */
	printf("global vars:\n");
	printf("	bit    molecaught:	%d\n", now.molecaught);
	printf("	int    moleposition:	%d\n", now.moleposition);
}
void
