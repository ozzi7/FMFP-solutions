...
#define SpinVersion	"Spin Version 6.2.1 -- 14 May 2012"
#define PanSource	"mole.pml"
...
#define nstates1	3	/* :init: */
#define minseq1	63
#define maxseq1	64
#define endstate1	2

#define nstates0	64	/* supervisor */
#define minseq0	0
#define maxseq0	62
#define endstate0	63
...
#define Psupervisor	((P0 *)this)
typedef struct P0 { /* supervisor */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, _1_1_1_target) - 1*sizeof(int))
